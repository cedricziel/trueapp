...
public class KeychainPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "com.cedricziel.truehub/keychain", binaryMessenger: registrar.messenger)
    ...
    private func storePassword(args: [String: Any], result: @escaping FlutterResult) {
        ...
        switch status {
        case errSecSuccess:
            print("KeychainPlugin: Successfully stored password for account: \(account) (sync: \(synchronizable))")
            result(true)

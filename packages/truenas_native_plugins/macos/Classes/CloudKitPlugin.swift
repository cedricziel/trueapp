...
public class CloudKitPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "com.cedricziel.truehub/cloudkit", binaryMessenger: registrar.messenger)
        let eventChannel = FlutterEventChannel(name: "com.cedricziel.truehub/cloudkit_events", binaryMessenger: registrar.messenger)

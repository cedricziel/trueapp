...
class AuthenticationSessionService {
  ...
  bool get isSessionValid {
    ...
    if (elapsed > sessionDuration) {
      if (kDebugMode) {
        print('AuthenticationSessionService: Session expired (elapsed: ${elapsed.inMinutes} minutes)');
      }
      invalidateSession();
      return false;
    }
  ...
  void markAuthenticated() {
    ...
    if (kDebugMode) {
      print('AuthenticationSessionService: Session authenticated at $_authenticatedAt');
    }
  }
